...
Public Class Rpt_ShowVend_All
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "Elhana.Rpt_ShowVend_All.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedRpt_ShowVend_All
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As Rpt_ShowVend_All = New Rpt_ShowVend_All()
        rpt.Site = Me.Site
        Return rpt
    End Function
