...
Public Class Rpt_Showcustomers
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "Elhana.Rpt_Showcustomers.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedRpt_Showcustomers
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As Rpt_Showcustomers = New Rpt_Showcustomers()
        rpt.Site = Me.Site
        Return rpt
    End Function
