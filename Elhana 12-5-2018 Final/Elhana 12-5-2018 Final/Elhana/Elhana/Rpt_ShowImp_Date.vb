...
Public Class Rpt_ShowImp_Date
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "Elhana.Rpt_ShowImp_Date.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedRpt_ShowImp_Date
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As Rpt_ShowImp_Date = New Rpt_ShowImp_Date()
        rpt.Site = Me.Site
        Return rpt
    End Function
