...
Public Class Rpt_ShowCust_All
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "Elhana.Rpt_ShowCust_All.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedRpt_ShowCust_All
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As Rpt_ShowCust_All = New Rpt_ShowCust_All()
        rpt.Site = Me.Site
        Return rpt
    End Function
