...
Public Class Rpt_Showvendors
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "Elhana.Rpt_Showvendors.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedRpt_Showvendors
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As Rpt_Showvendors = New Rpt_Showvendors()
        rpt.Site = Me.Site
        Return rpt
    End Function
