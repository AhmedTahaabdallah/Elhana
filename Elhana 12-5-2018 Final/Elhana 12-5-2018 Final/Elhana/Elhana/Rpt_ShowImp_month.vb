...
Public Class Rpt_ShowImp_month
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "Elhana.Rpt_ShowImp_month.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedRpt_ShowImp_month
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As Rpt_ShowImp_month = New Rpt_ShowImp_month()
        rpt.Site = Me.Site
        Return rpt
    End Function
