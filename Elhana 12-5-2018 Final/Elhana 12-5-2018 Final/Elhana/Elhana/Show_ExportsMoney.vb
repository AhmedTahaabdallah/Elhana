...
Imports System.Data
Public Class Show_ExportsMoney
    Public tp As String
    Public pr As String
    Public month_id As Integer
    Public month_id99 As Integer
    ...
    Public Vend_blance As Integer
    Public mr As Integer
    Public dy As String
    Public dm As String
    Public dd As String
    Public dstri As String
    Public custty As String
    Public vendty As String
    'Public gcon As New OleDbConnection
    Private Sub ComboBox1_SelectedIndexChanged(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles ComboBox1.SelectedIndexChanged
        Try
            If ComboBox1.Text = "كل أذونات الصرف" Then
    ...
    Private Sub Show_ExportsMoney_Load(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles MyBase.Load
        'gcon.ConnectionString = "Provider=Microsoft.ACE.OLEDB.12.0;Data Source=E:\Data Base\Tiba no2.accdb; Persist Security Info=False"
        Try
    ...
    Private Sub ComboBox4_DropDown(ByVal sender As Object, ByVal e As System.EventArgs) Handles ComboBox4.DropDown
        Try
            ...
            Do While Not rs_Cars.EOF
                ComboBox4.Items.Add(rs_Cars("Vend_Name").Value)
                rs_Cars.MoveNext()
            Loop
            rs_Cars.Close()
        Catch ex As Exception
    ...
    Private Sub ComboBox4_SelectedIndexChanged(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles ComboBox4.SelectedIndexChanged
        Try
            ...
            'Vend_blance = rs_Cars("Vend_Blance_Dein").Value
            'vendty = rs_Cars("Vend_Blance_Type").Value
            rs_Cars.Close()
        Catch ex As Exception
            MessageBox.Show(ex.Message, "خطأ فى البرنامج")
        End Try
    ...
    Private Sub Button2_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles Button2.Click
        Try
            If pr = "All" Then
                ...
                Dim rpt As New Rpt_ShowExp_All
                Dim frm_rpt As New Frm_rpt_ShowExp_All
                rdat.Clear()
            ...
            If pr = "date" Then
                Me.Cursor = Cursors.WaitCursor
                Dim rpt As New Rpt_ShowExp_Date
                Dim frm_rpt As New Frm_rpt_ShowExp_Date
                rdat.Clear()
                rcon = New SqlConnection("Data Source=PC-PC\SQLEXPRESS;Password=141751527;Persist Security Info=True;User ID=sa;Initial Catalog=Elhana")
                rcon.Open()
                Dim ssd As Boolean
                ...
                With frm
                    .Controls.Add(frm_rpt.CrystalReportViewer1)
                    .Text = "طباعة أذونات الصرف بتاريخ ما"
                    .WindowState = FormWindowState.Maximized
                    .ShowDialog()
                End With
            ...
            If pr = "month" Then
                Me.Cursor = Cursors.WaitCursor
                Dim rpt As New Rpt_ShowExp_month
                Dim frm_rpt As New Frm_rpt_ShowExp_month
                rdat.Clear()
                rcon = New SqlConnection("Data Source=PC-PC\SQLEXPRESS;Password=141751527;Persist Security Info=True;User ID=sa;Initial Catalog=Elhana")
                rcon.Open()
                Dim ssd As Boolean
                ...
                With frm
                    .Controls.Add(frm_rpt.CrystalReportViewer1)
                    .Text = "طباعة أذونات الصرف لشهر واحد"
                    .WindowState = FormWindowState.Maximized
                    .ShowDialog()
                End With
            ...
            If pr = "Vendor" Then
                Me.Cursor = Cursors.WaitCursor
                Dim rpt As New Rpt_ShowExp_vend
                Dim frm_rpt As New Frm_rpt_ShowExp_vend
                rdat.Clear()
                rcon = New SqlConnection("Data Source=PC-PC\SQLEXPRESS;Password=141751527;Persist Security Info=True;User ID=sa;Initial Catalog=Elhana")
                rcon.Open()
                Dim ssd As Boolean
                ...
                End If
                If rs_Cars.State = 1 Then rs_Cars.Close()
                rs_Cars.Open("Select * From Vendores Where Vend_ID='" & cust_id6 & "' And Vend_DelFlag='" & ssd & "' And Vend_visable='" & ssd & "'", cn1, ADODB.CursorTypeEnum.adOpenDynamic, ADODB.LockTypeEnum.adLockOptimistic)
                Vend_blance = rs_Cars("Vend_Blance_Dein").Value
                vendty = rs_Cars("Vend_Blance_Type").Value
                rada = New SqlDataAdapter(rcomand)
                Dim sio As String
            ...
            If pr = "month_Vendor" Then
                ...
                tp = "Exp"
                'rcomand = New SqlCommand("Select sm.Stor_ID, (Select vend.Cust_Name From Customers as vend Where vend.Cust_ID = sm.Cust_ID) as custname,(Select vend.Item_Name From Itemes as vend Where vend.Item_ID = sm.Item_ID) as itemname, sm.Stor_Date, sm.Stor_Quntity_No, sm.Stor_Price_tin, sm.Stor_Total_Price, sm.Stor_Payment, sm.Stor_Note From Stor as sm Where sm.Stor_Type='" & tp & "' And sm.Stor_DelFlag='" & ssd & "' ORDER BY sm.Stor_Date ASC", rcon)
                rcomand = New SqlCommand("Select ie.Money_ID, ie.Money_Date, ie.Money_Price, ie.Money_Reason, ie.Money_Note FROM Imp_Exp_Money as ie where ie.Month_ID=" & month_id99 & " And ie.Vend_ID=" & cust_id6 & " And ie.Money_Type='" & tp & "' And ie.Money_DelFlag='" & ssd & "' ORDER BY ie.Money_Date DESC", rcon)

                If rs_StoreVend.State = 1 Then rs_StoreVend.Close()
                rs_StoreVend.Open("Select Sum(ie.Money_Price) as c_No FROM Imp_Exp_Money as ie where ie.Month_ID=" & month_id99 & " And ie.Vend_ID=" & cust_id6 & " And ie.Money_Type='" & tp & "' And ie.Money_DelFlag='" & ssd & "'", cn1, ADODB.CursorTypeEnum.adOpenDynamic, ADODB.LockTypeEnum.adLockOptimistic)
                If IsDBNull(rs_StoreVend("c_No").Value) Then
                    T_Name = 0
                Else
                    T_Name = rs_StoreVend("c_No").Value
                ...
                With frm
                    .Controls.Add(frm_rpt.CrystalReportViewer1)
                    .Text = "طباعة أذونات الصرف لمورد لشهر ما"
                    .WindowState = FormWindowState.Maximized
                    .ShowDialog()
                End With
            ...
            If pr = "Customer" Then
                ...
                End If
                If rs_Cars.State = 1 Then rs_Cars.Close()
                rs_Cars.Open("Select * From Customers Where Cust_ID=" & cust_id6 & " And Cust_DelFlag='" & ssd & "' And Cust_visable='" & ssd & "'", cn1, ADODB.CursorTypeEnum.adOpenDynamic, ADODB.LockTypeEnum.adLockOptimistic)
                Cust_blance = rs_Cars("Cust_Blance_Medin").Value
                custty = rs_Cars("Cust_Blance_Type").Value
                rada = New SqlDataAdapter(rcomand)
                Dim sio As String
                Dim kl As String
                sio = "لعميل"
            ...
            If pr = "month_Customer" Then
                ...
                tp = "Exp"
                'rcomand = New SqlCommand("Select sm.Stor_ID, (Select vend.Cust_Name From Customers as vend Where vend.Cust_ID = sm.Cust_ID) as custname,(Select vend.Item_Name From Itemes as vend Where vend.Item_ID = sm.Item_ID) as itemname, sm.Stor_Date, sm.Stor_Quntity_No, sm.Stor_Price_tin, sm.Stor_Total_Price, sm.Stor_Payment, sm.Stor_Note From Stor as sm Where sm.Stor_Type='" & tp & "' And sm.Stor_DelFlag='" & ssd & "' ORDER BY sm.Stor_Date ASC", rcon)
                rcomand = New SqlCommand("Select ie.Money_ID, ie.Money_Date, ie.Money_Price, ie.Money_Reason, ie.Money_Note FROM Imp_Exp_Money as ie where ie.Month_ID=" & month_id99 & " And ie.Cust_ID=" & cust_id6 & " And ie.Money_Type='" & tp & "' And ie.Money_DelFlag='" & ssd & "' ORDER BY ie.Money_Date DESC", rcon)

                If rs_StoreVend.State = 1 Then rs_StoreVend.Close()
                rs_StoreVend.Open("Select Sum(ie.Money_Price) as c_No FROM Imp_Exp_Money as ie where ie.Month_ID=" & month_id99 & " And ie.Cust_ID=" & cust_id6 & " And ie.Money_Type='" & tp & "' And ie.Money_DelFlag='" & ssd & "'", cn1, ADODB.CursorTypeEnum.adOpenDynamic, ADODB.LockTypeEnum.adLockOptimistic)
                If IsDBNull(rs_StoreVend("c_No").Value) Then
                    T_Name = 0
                Else
                    T_Name = rs_StoreVend("c_No").Value
            ...
            If pr = "re" Then
                Me.Cursor = Cursors.WaitCursor
                Dim rpt As New Rpt_ShowExp_reason
                Dim frm_rpt As New Frm_rpt_ShowExp_reason
                rdat.Clear()
                rcon = New SqlConnection("Data Source=PC-PC\SQLEXPRESS;Password=141751527;Persist Security Info=True;User ID=sa;Initial Catalog=Elhana")
                rcon.Open()
                Dim ssd As Boolean
                ...
                With frm
                    .Controls.Add(frm_rpt.CrystalReportViewer1)
                    .Text = "طباعة أذونات الصرف حسب البيان"
                    .WindowState = FormWindowState.Maximized
                    .ShowDialog()
                End With
            ...
            If pr = "remo" Then
                Me.Cursor = Cursors.WaitCursor
                Dim rpt As New Rpt_ShowExp_reason_Month
                Dim frm_rpt As New Frm_rpt_ShowExp_reason_Month
                rdat.Clear()
                rcon = New SqlConnection("Data Source=PC-PC\SQLEXPRESS;Password=141751527;Persist Security Info=True;User ID=sa;Initial Catalog=Elhana")
                rcon.Open()
                Dim ssd As Boolean
                ...
                With frm
                    .Controls.Add(frm_rpt.CrystalReportViewer1)
                    .Text = "طباعة أذونات الصرف حسب البيان لشهر واحد"
                    .WindowState = FormWindowState.Maximized
                    .ShowDialog()
                End With
    ...
    Private Sub ComboBox5_DropDown(ByVal sender As Object, ByVal e As System.EventArgs) Handles ComboBox5.DropDown
        Try
            ...
            Do While Not rs_Cars.EOF
                ComboBox5.Items.Add(rs_Cars("Cust_Name").Value)
                rs_Cars.MoveNext()
            Loop
            rs_Cars.Close()
        Catch ex As Exception
