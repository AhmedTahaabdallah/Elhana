...
Imports System.Data
Public Class Frm_ShowStoreCust
    ...
    Private Sub Button1_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles Button1.Click
        Try
            ...
            If ComboBox1.Text = "كل الاذونات" Then
                ...
                'Button2.Visible = True
            End If
            If ComboBox1.Text = "كل أذونات الصادرات للموردين" Then
                DataGridView1.DataSource = ""
                DataGridView1.Refresh()
                get_allVend()
            ...
            End If
            If ComboBox1.Text = "كل أذونات الصادرات للعملاء" Then
                DataGridView1.DataSource = ""
                DataGridView1.Refresh()
                get_allCust()
                If auth_report = uh Then
            ...
            If ComboBox1.Text = "الشهر" Then
                ...
                'Button2.Visible = True
            End If
            If ComboBox1.Text = "الشهر لصادرات الموردين" Then
                If ComboBox4.Text = "" Then
                    MsgBox("من فضلك أختر الشهر", MsgBoxStyle.Information, "تنبيه")
                    ComboBox4.Select()
                    Exit Sub
                ...
                End If
            End If
            If ComboBox1.Text = "الشهر لصادرات العملاء" Then
                If ComboBox4.Text = "" Then
                    MsgBox("من فضلك أختر الشهر", MsgBoxStyle.Information, "تنبيه")
                    ComboBox4.Select()
                    Exit Sub
        ...
        Try
            If pr = "AllVend" Then
                ...
                With frm
                    ...
                    .Text = "طباعة كل أذونات الصادرات للموردين"
            ...
            If pr = "AllCust" Then
                ...
                With frm
                    .Controls.Add(frm_rpt.CrystalReportViewer1)
                    .Text = "طباعة كل أذونات الصادرات للعملاء"
                    .WindowState = FormWindowState.Maximized
                    .ShowDialog()
                End With
            ...
            If pr = "fatora_Vend" Then
                ...
                With frm
                    .Controls.Add(frm_rpt.CrystalReportViewer1)
                    .Text = "طباعة فاتورة صادرات لمورد"
                    .WindowState = FormWindowState.Maximized
                    .ShowDialog()
                End With
            ...
            If pr = "monthvend" Then
                ...
                With frm
                    .Controls.Add(frm_rpt.CrystalReportViewer1)
                    .Text = "طباعة أذونات الصادرات للموردين لشهر ما"
                    .WindowState = FormWindowState.Maximized
                    .ShowDialog()
                End With
            ...
            If pr = "Vendor_month" Then
                ...
                With frm
                    .Controls.Add(frm_rpt.CrystalReportViewer1)
                    .Text = "طباعة صادرات مورد فى شهر واحد"
                    .WindowState = FormWindowState.Maximized
                    .ShowDialog()
                End With
            ...
            If pr = "Customer_month" Then
                ...
                With frm
                    .Controls.Add(frm_rpt.CrystalReportViewer1)
                    .Text = "طباعة صادرات عميل فى شهر واحد"
                    .WindowState = FormWindowState.Maximized
                    .ShowDialog()
                End With
