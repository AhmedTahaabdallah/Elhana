...
Public Class Rpt_ShowExp_month
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "Elhana.Rpt_ShowExp_month.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedRpt_ShowExp_month
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As Rpt_ShowExp_month = New Rpt_ShowExp_month()
        rpt.Site = Me.Site
        Return rpt
    End Function
