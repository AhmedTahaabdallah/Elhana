...
Public Class Rpt_ShowCust_date
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "Elhana.Rpt_ShowCust_date.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedRpt_ShowCust_date
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As Rpt_ShowCust_date = New Rpt_ShowCust_date()
        rpt.Site = Me.Site
        Return rpt
    End Function
