...
Public Class Rpt_ShowImp_reason
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "Elhana.Rpt_ShowImp_reason.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedRpt_ShowImp_reason
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As Rpt_ShowImp_reason = New Rpt_ShowImp_reason()
        rpt.Site = Me.Site
        Return rpt
    End Function
