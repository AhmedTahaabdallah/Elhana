...
Public Class Rpt_ShowVend_date
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "Elhana.Rpt_ShowVend_date.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedRpt_ShowVend_date
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As Rpt_ShowVend_date = New Rpt_ShowVend_date()
        rpt.Site = Me.Site
        Return rpt
    End Function
